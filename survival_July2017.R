...
t.test(data71$close,data71$sham, paired=TRUE)
###t-test comparing open vs sham
t.test(data71$surviving,data71$sham, paired=TRUE)
...
ggplot.eb.open<- ggplot(data2.summary, 
  ...
  ylab("")+
  theme_few()
ggsave('ggplot.eb.open_july_2017.png', width=4, height=2)
ggplot.eb.open
...
ggplot.eb.closed<- ggplot(data2.summary.closed, 
  ...
  ylab("")+
  theme_few()
ggsave('ggplot.eb.closed_july_2017.png', width=4, height=2)
...
ggplot.eb.sham<- ggplot(data2.summary.sham, 
  ...
  ylab("")+
  theme_few()
ggsave('ggplot.eb.sham_july_2017.png', width=4, height=2)
...
ggplot(summary.melt, aes(x=hours_since_deployment, y=mean, fill=variable))+
  ...
  ylim(0,1)+
  scale_x_continuous(expand = c(0, 0), limits = c(0, 75), breaks=c(0, 10, 20, 30, 40, 50, 60, 70))
ggsave('ggplotsurvivalbyexclosureJuly2017.png', width=7, height=6)
